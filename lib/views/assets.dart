...
// List of assets to be displayed in the list
  List<ListItem> assets = [
    ...
    ListItem(title: 'Home Security Monitoring', icon: Icons.home, status: AssetStatus.connected),
    ListItem(title: 'Home Security Monitoring', icon: Icons.home, status: AssetStatus.disconnected),
    ...
    ListItem(title: 'Police Car Monitoring System 8', icon: Icons.directions_car,status: AssetStatus.connected),
