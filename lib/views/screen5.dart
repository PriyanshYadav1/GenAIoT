...
//     super.initState();
//     //initializeLiveData();
//     var assetIdentity = "da-47-3c-a3-90-1b";
//     showData(assetIdentity);
//     _loadData();
//   }
//
...
//     final response = await rootBundle.loadString('assets/json_files/live_data.json');
//     final data = json.decode(response);
//     setState(() {
//       liveDataList = (data['live_data'] as List)
//           .map((liveDataJson) => LiveData.fromJson(liveDataJson))
//           .toList();
//     });
//   }
//
...
//         final gaugeData = liveDataList[index];
//
//         return Card(
//           elevation: 55,
...
//                       child: KdGaugeView(
//                         minSpeed: gaugeData.minimumValue,
//                         maxSpeed: gaugeData.maximumValue,
...
//   }
//
//   Future<Map<String, dynamic>?> showData(String assetId) async {
//     var jsonResponse = await get("/api/live_event:+${assetId}");
//     print("JSON-RESPONE ========= "+jsonResponse.toString());
//     return null;
//   }
// }
//
...
// List<LiveData> parseLiveDataList(String jsonString) {
//   final List<dynamic> jsonList = jsonDecode(jsonString);
//   return jsonList.map((jsonItem) {
//     return LiveData(
//       dataType: jsonItem['data_type'],
//       unitOfMeasurement: jsonItem['unit_of_measurement'],
//       minimumValue: jsonItem['minimum_value'],
//       maximumValue: jsonItem['maximum_value'],
//       actualValue: jsonItem['actual_value'],
//       timeStamp: jsonItem['ts'],
//       dateTime: jsonItem['dt'],
//       widgetType: jsonItem['widgetType'],
//       //timetamp: DateTime.fromMillisecondsSinceEpoch(jsonItem['ts'] * 1000), // Convert seconds to milliseconds
//     );
//   }).toList();
// }
//
